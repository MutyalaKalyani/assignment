...
import "./displayByStatus.css";

const DisplayByStatus = ({ data }) => {
  console.log(data);
  return (
    <div className="divContainerStatus">
      {data &&
        Object.keys(data).map((key) => {
          return (
            <div class="boxContainerStatus">
              <div className="userInfos">
                <div className="userInfoDivs">
                  ...
                  <span className="titleStyles">{key}</span>
                  <span className="cardLengths">{data[key].length}</span>
                </div>
                <div className="userInfoDivs">
                ...
                {data[key].map((cam) => {
                  return (
                    <div className="cardContainers">
                      <span className="camIds">{cam.id}</span>

                      <span className="camTitles">{cam.title}</span>
                      <div className="camExtraInfos">
                        {cam.priority === 0 && (
                          <svg
                            width="16"
                            height="16"
                        ...
                        <span className="camTags">{cam.tag}</span>
                      </div>
                    </div>
                  );
                })}
