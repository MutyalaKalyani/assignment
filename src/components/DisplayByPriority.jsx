...
import "./displayByPriority.css";
const DisplayByPriority = ({ data }) => {
  console.log(data);
  return (
    <div className="divContainerp">
      {data &&
        Object.keys(data).map((key) => {
          return (
            <div class="boxContainerp">
              <div className="userInfop">
                <div className="userInfoDivp">
                  {key === "0" && (
                    <svg
                      width="16"
                      height="16"
                  ...
                  {key === "0" && (
                    <span className="titleStylep">Low Priority</span>
                  )}
                  {key === "4" && <span className="titleStylep">Urgent</span>}
                  {key === "3" && <span className="titleStylep">High</span>}
                  {key === "2" && <span className="titleStylep">Medium</span>}
                  {key === "1" && <span className="titleStylep">Low</span>}
                  <span className="cardLengthp">{data[key].length}</span>
                </div>
                <div className="userInfoDivp">
                  <span className="logop">
                    {" "}
                    <svg
                      width="16"
                      height="16"
                ...
                {data[key].map((cam) => {
                  return (
                    <div className="cardContainerp">
                      <span className="camIdp">{cam.id}</span>
                      <div className="camInfop">
                        {cam.status === "Todo" && (
                          <svg
                            width="14"
                            height="14"
                        ...
                        <span className="camTitlep">{cam.title}</span>
                      </div>
                      <div className="camExtraInfop">
                        <span className="camTagp">{cam.tag}</span>
                      </div>
                    </div>
                  );
                })}
