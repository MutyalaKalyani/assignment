...
import "./displaybyUser.css";
const DisplayByUser = ({ data }) => {
  console.log(data);
  return (
            ...
            <div class="boxContainer">
              <div className="userInfo">
                <div className="userInfoDiv">
                  <span className="titleStyle">{key}</span>
                  <span className="cardLength">{data[key].length}</span>
                </div>
                <div className="userInfoDiv">
                  <span className="logo">
                    {" "}
                ...
                {data[key].map((cam) => {
                  return (
                    <div className="cardContainer">
                      <span className="camId">{cam.id}</span>
                      <div className="camInfo">
                        ...
                        <span className="camTitle">{cam.title}</span>
                      </div>
                      <div className="camExtraInfo">
                        {cam.priority === 0 && (
                          <svg
                            width="16"
                            height="16"
                        ...
                        <span className="camTag">{cam.tag}</span>
                      </div>
                    </div>
                  );
                })}
